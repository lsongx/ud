...
class ResSelectiveFC(nn.Module):
...
def resnet18(model_path_prefix=None, **kwargs):
    ...
    return ResSelectiveFC(model, **kwargs)
...
def mobilenet_v2(model_path_prefix=None, **kwargs):
    ...
    return ResSelectiveFC(model, use_feat_layer=True, **kwargs)
